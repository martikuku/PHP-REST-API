...
class Api
{
    ...
    private static $main_format = 'xml';

    private static $request_version = null; // 1.0
    private static $request_format = null;  // xml
    ...
    public static function serve()
    {
        ...
        if ($request_method == 'options') {
            ...
            call_user_func_array(array($api_object, $request_method), array($params_matches, self::$input_data)); // druhý parametr self::$input_data přidán kvůli post()
        }
    }
